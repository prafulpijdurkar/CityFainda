...
public class AboutModelImpl implements About.Model {
    ...
    private static final String FILE_NAME = "about_info.jsonn";
    ...
    public void getAboutInfo() {
        ...
        MockResponseManager.getInstance().getAbout(presenter);
//        String aboutInfoJson = getAboutInfoFromAssets();
//
//        if(aboutInfoJson != null && !aboutInfoJson.isEmpty()){
//    		AboutInfo about_info = parseAboutInfo(aboutInfoJson);
//    		if (about_info != null){
//        		presenter.onSuccess(MockResponseManager.getInstance().getAbout(presenter););
//        		return;
//   		 	}
//		}
